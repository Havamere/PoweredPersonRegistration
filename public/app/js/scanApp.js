	...
	$('#submit').on('click', function() {
		...
		.done(function( detectData ) {
			...
			if (detectData.face.length !== 0) {
				...
				alert('Your face in this picture is not clear enough for our software to recognize.  Please use a different picture.')
				alert('Updates to your facebook account may take up to 24 hours to take effect on their services.')
			}
		});
		var userProfile = {
			'user': user.user,
